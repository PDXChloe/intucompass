"""
Django settings for KidPortfolio project.
...
SECRET_KEY = 'tnv+hwh%b6wx4a)#rmx4(t&!*+o#g-xb-wqdb-mm8dhe=0xw+0'
...
ROOT_URLCONF = 'KidPortfolio.urls'
...
WSGI_APPLICATION = 'KidPortfolio.wsgi.application'
